...
const LandHead = () => {
  return (
    <div className="mt-40 md:mt-20">
      <div className="flex flex-wrap items-center justify-center space-x-2 bg-gray-50/5 bg-auto md:bg-contain  px-0 md:px-10 py-2 rounded-lg border border-zinc-900 mb-8">
        <Image
          className=""
          src="/bgr-logo.png"
          width={20}
