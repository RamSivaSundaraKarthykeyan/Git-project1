  ...
  return (
    <>
      <div className="w-full">
        <div className="mx-30 rounded-2xl bg-gray-50 flex justify-evenly">
          <div className="flex items-start fixed top-0 right-0 left-0 px-6 py-3 text-white text-sm font-medium ">
            <picture>
              <Link href="/">
                <Image
