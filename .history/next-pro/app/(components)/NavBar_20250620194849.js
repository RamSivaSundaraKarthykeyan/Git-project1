    ...
    <>
      <div className="w-full">
        <div className="flex justify-center justify-evenly">
          <div className="flex items-center justify-between bg-black bg-opacity-80 backdrop-blur-md px-6 py-3 text-white text-sm font-medium">
            <picture>
              <Link href="/">
                <Image
          ...
          <div>
            <Link href="/about">
              <button className="px-4 py-2 rounded-full bg-gray-700 text-white hover:bg-gray-600 my-2">
                Get Started
              </button>
            </Link>
          </div>
