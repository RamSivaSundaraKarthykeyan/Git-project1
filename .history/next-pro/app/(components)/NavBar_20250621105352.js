  ...
  return (
    <>
      <div className="w-full">
        <div className="mx-4 my-6 grid grid-cols-1 md:grid-cols-3 items-center gap-y-4 md:gap-x-10 rounded-2xl bg-gray-50/5">
          {/* Logo */}
          ...
          <div className="flex justify-center md:justify-end px-4">
            <Link href="/about">
              <button className="px-6 py-3 rounded-2xl bg-gray-50/10 hover:bg-gray-50/20 text-white">
                Get Started {">"}
              </button>
            </Link>
          </div>
