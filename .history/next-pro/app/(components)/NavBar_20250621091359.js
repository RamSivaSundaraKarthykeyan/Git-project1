  ...
  return (
    <>
      <div className="w-full">
        <div className="mx-30 my-9.5 grid grid-cols-3 gap-150 rounded-2xl bg-gray-50/5 justify-evenly">
          ...
          <div className="flex gap-x-16 pt-4 text-white text-sm justify-center my-3 font-medium">
          ...
          <div>
            <Link href="/about">
              <button className="px-4 my-2.5 rounded-2xl py-4 bg-gray-700 hover:bg-gray-600">
                Get Started {">>"}
              </button>
            </Link>
          </div>
