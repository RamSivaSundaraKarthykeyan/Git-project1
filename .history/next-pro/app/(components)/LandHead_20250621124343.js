...
const LandHead = () => {
  return (
    <div className="mt-40 md:mt-20">
      <div className="inline-flex flex-wrap items-center justify-center gap-2 md:gap-4 bg-gray-50/5 px-4 md:px-10 py-2 rounded-lg border border-zinc-900 mb-8 w-[400px] mx-auto">
        <Image
          className=""
          src="/bgr-logo.png"
          width={20}
