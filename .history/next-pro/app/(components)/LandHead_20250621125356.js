...
const LandHead = () => {
  return (
    <div className="mt-40 md:mt-20">
      ...
      <div className="flex mx-5 text-pretty flex-col justify-center items-center">
        <p>
          With just €10, you can begin building a thoughtful investment
          portfolio and back purposeful businesses.
        </p>
      </div>
    </div>
  );
