  ...
  return (
    <>
      <div className="w-full">
        <div className="mx-30 rounded-2xl bg-gray-50 flex justify-center justify-evenly">
          <div className="flex items-start justify-between  px-6 py-3 text-white text-sm font-medium ">
            <picture>
              <Link href="/">
                <Image
