  ...
  return (
    <>
      <div className="w-full">
        <div className="mx-30 my-9.5 grid grid-cols-3 gap-155 rounded-2xl bg-gray-50/5 justify-evenly">
          ...
          <div>
            <Link href="/about">
              <button className="px-1.5 py-4 mx-4 my-2.5 rounded-2xl items-end bg-gray-700 hover:bg-gray-600">
                Get Started {">"}
              </button>
            </Link>
          </div>
